...
school_size_selector = dcc.Input(
    ...
    value=500,
    debounce=False,
    style={'display': 'flex', 'flexDirection': 'column', 'fontFamily': 'Sans-serif', 'font-size': '16pt',
           'textAlign': 'center', 'width': '6ch'}
)
...
I0_selector = dcc.Input(
    ...
    min=0,
    debounce=False,
    style={'display': 'flex', 'flexDirection': 'column', 'margin-left': 'auto', 'fontFamily': 'Sans-serif',
           'font-size': '16pt', 'textAlign': 'center', 'width': '6ch'}
)
...
accordion_vax = dbc.Accordion(
    [
        dbc.AccordionItem(
            html.Div(
                [
                    html.H3("ISD rates are district averages.", style={"text-align": "center",
                                                                       "font-family": '"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif',
                                                                       "font-size": "12pt", "font-weight": "400",
                                                                       "font-style": "italic", "line-height": "1"}),
                    html.H3("Rates at individual schools may be higher or lower.", style={"text-align": "center",
                                                                                          "font-family": '"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif',
                                                                                          "font-size": "12pt",
                                                                                          "font-weight": "400",
                                                                                          "font-style": "italic",
                ...
                dbc.Card(
                    dbc.CardBody(
                        [
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.H3("Enter value or select from Lookup.", style={"text-align": "center",
                                                                                         "font-family": '"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif',
                                                                                         "font-size": "12pt",
                                                                                         "font-weight": "400",
                                                                                         "font-style": "italic",
                                                                                         "line-height": "1"}),
                                    html.H3("Update School Enrollment above.", style={"text-align": "center",
                                                                                      "font-family": '"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif',
                                                                                      "font-size": "12pt",
                                                                                      "font-weight": "400",
                                                                                      "font-style": "italic",
            ...
            dbc.Col([
                ...
                html.H3(
                    ...
                    style={"text-align": "center",
                           "font-family": '"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif',
                           "font-size": "12pt", "font-weight": "400", "font-style": "italic", "line-height": "1"}),
                html.H3(
...
def update_graph(school_size, vax_rate, I0, R0, latent_period, infectious_period):
    ...
    if stochastic_sim.mean_outbreak_given_20_new_infections == 'NA':
        ...
        mean_outbreak_given_20_new_infections_str = str(int(stochastic_sim.mean_outbreak_given_20_new_infections))
